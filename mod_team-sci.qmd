...
![Novelty peaks at a team size of about 6 authors (examining only authors from a single private university. From: Lee et al. 2014](images/Lee_et_al_2014.jpg){style="padding: 15px"}
...
Meet as project teams in breakout groups for 10 minutes. Each group comes up with one practice that they could include in their group practice guidelines to support each of the above mechanisms. In large group, each project group describes one of their practices and how they think it will help.
...
1. Navigate to the [notes document](https://docs.google.com/document/d/1ctancqRacgM75UDYrXvi1lvJmHxAyWE19ie4GAYhRBU/edit) in the cohort folder.
