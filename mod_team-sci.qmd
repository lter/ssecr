...
The paradox of team science is that the very factors that slow progress may be _exactly_ the factors that generate new insight -- Milliken and Martins' (1996) double-edged sword. The pressing question became not "**Does** diversity impove team performance?" but "**When** does diversity improve team performance?" 


**What mechanisms are responsible for the diversity effect?**
(Pieterse et al. 2013,  van Knippenberg and Hoever 2017)

::: {.callout-note icon="information" collapse="true"}
...
*  Avoiding ‘groupthink’
*  Better information elaboration ()
...
**What practices support those mechanisms?** 

*  Learning goal orientation
*  Openness to revising assumptions and world views
*  Cognitive elaboration (spelling out your assumptions and mental models)
*  Metacognition (check reference)
*  Effective coordination
*  Participants are able to contribute in the manner and at the times that they are best

**Influencing factors**

*  What kinds of diversity?
    *  Disciplinary 
    *  Technical/scientific/organizational/interpersonal skills
    *  Gender
    *  Racial/ethnic background
    *  Sectoral

*  Cognitive trust (The rational belief that group members can and will deliver on their portion of the work)
    *  Articulate your coordination practices
    *  Where will you keep data? How will you communicate? How often will you meet? What’s your authorship model? Do these work for slow and fast processors? Introverts and extroverts?

*  Affective Trust (The belief (usually grounded in common experience) that group members have your best interests in mind)
    ...
    *  Pay attention to mutual respect and speaking time
    *  Consider assigning a vibes-keeper
    *  Allowing time/space for cognitive elaboration
    *  Spend time early to talk through various perspectives on the question that may be present in the group
    *  Be willing to look foolish. Ask the “dumb” questions. That’s how unarticulated assumptions get surfaced.
...
Plan for conflict. Don’t ignore it.
...
![](/images/satisfaction-triangle.png){style="width: 90%; align: center; padding:20px"}
...
*  Where is Alex in the satisfaction traingle? Where are the other group members?
*  Identify at least three points at which someone could have intervened to change this outcome
*  Who and how?
...
Later that week,  when the wildlife subgroup meets, they get excited about finding wildlife sightings through NextDoor and began pursuing the idea. It works out better than they could have hoped and James, an assistant professor in computer science who is preparing his tenure package, spearheads a paper on their use of the technique. At the next full group meeting, he mentions that it is ready to be submitted. 
...
*  What is James’ responsibility? 
*  How might the group have avoided the situation in the first place?

## Research Approach

Arturo, a climate scientist with a large lab, brings two postdocs and a grad student to the first working group meeting of the causes of harmful algal blooms working group.  In deciding which scenarios to evaluate, Arturo posits that temperature, rainfall, and growing degree-days will be the primary drivers and offers to assign one to each of his lab members.

Jasmine, an assistant professor in agronomy with a heavy teaching load,  thinks that fertilizer rate and timing of application will be major drivers. She has time to find relevant datasets, but can’t commit to doing the analysis and doesn’t have students to assign to it. 

**Discussion questions**

*  Where is Jasmine on the satisfaction traingle? What about Arturo's postdoc?
*  How should the group go about allocating effort?
*  Is it fair to ask one of Arturo’s postdocs to work outside their field? Why might they want (or not want) to do that?
*  Should they try to invite another agronomist to the group?

:::

### Group Discussion

Each group describes their analysis of the situation and a proposed solution/intervention. Discuss commonalities and any ideas/proposals for updating group ground rules or process plan.
