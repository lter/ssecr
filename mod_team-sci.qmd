...
<p align="center"/>
<img src="images/figure_team-dev-phases.jpg" alt="graphic, laying out the 5 phases: forming, storming, norming, performing, and adjourning, with accompanying fluctuations in team performance" width="100%" />
</p>
...
<img src="images/graph_team-size-novelty.jpg" alt="Graph showing novelty peaks at a team size of about 6 authors (examining only authors from a single private university). From: Lee et al. 2014" width="45%" align="right"/>
...
<figure>
<img src="images/graph_team-gender-novelty.png" alt="Graph showing that mixed-gender teams are more likely to produce novel papers than same-gender teams at all team sizes" width="100%"/>
...
<img src="images/text_go-far.png" alt="Colored background behind the quote 'If you want to go fast, go alone; if you want to go far, go together'" width="50%" align="right" />
...
<figure>
<img src="images/graphic_translational-team-competencies.png" alt="Graphic showing how 'team communication', 'collaborative problem-solving' and 'managing team research' intersect and how those intersections benefit either team bonding or team leadership" width="100%" />
...
<img src="images/text_conflict-def.png" alt="Colored background behind the quote 'Conflict is a crisis that forces us to recognize explicitly that we live with multiple realities and must negotiate a common reality;  that we bring to each situation differing--frequently contrasting--stories and must create a single shared story with a role for each and for both'" width="60%" align="right" />
...
<img src="images/graph_satisfaction-triangle.png" alt="A triangle labeled 'satisfaction triangle' indicating how procedural, emotional, and structural considerations are all important to satisfaction" width="100%" />
