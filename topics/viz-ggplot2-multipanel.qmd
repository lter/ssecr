...
- <u>Describe</u> the difference(s) between "faceted" graphs and "plot grids" 
- <u>Create</u> faceted `ggplot2` graphs
- <u>Assemble</u> grids of plots
...
### {{<fa rocket >}} Activity: Multi-Panel Graph Creation

In a script, attempt the following:

1. Create two graphs with `ggplot2` that have _different geometries_
