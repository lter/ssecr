...
![](topics/images/figure_analysis-flow.png){fig-alt="Rectangular boxes containing data sources (Si concentration, streamflow, watershed geometry and land use, watershed precipitation), linked to diamond-shaped boxed describing processing steps, linked to more rectangles with output" .lightbox}
<figcaption>Analysis flowchart for a test of controls on Silica exports in streamflow.</figcaption>
