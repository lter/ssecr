...
library(sf); library(terra); library(magrittr)
...
# This chunk made the graph and exported it locally
# So that we can just embed the image directly and avoid the computing of actually making the map
