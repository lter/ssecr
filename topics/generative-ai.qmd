...
**AI Agents** – Agentic AI tasks consume orders of magnitude more than a short chat. Heavy agentic AI use is where the electricity consumption becomes more environmentally significant. Rough estimates here indicate each person-day of agentic AI use has the energy footprint of running a couple of refridgerators, all day long [@hausfather_real_2026], or about 7% of the average American's daily electricity use [@ritchie_how_2026_2].
