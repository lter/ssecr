...
| **Microstructure** | **Purpose** | **How It Works** | **Tips & Traps** |
|:---|:------------|:--------------------|:---------------|
| Open discussion | Group inquiry, sensemaking, and/or decision-making | Clearly define the scope; set agreements for inclusive discussion; invite discussion about the topic at hand; capture ideas and questions; listen for when the group is ready to converge | Keep track of side topics (e.g. in a "bike rack") and make time to come back to them, but don't let them derail |
...
### {{<fa rocket >}} Activity: Group Process Design Check-In
...
- Think about the next group work or decision-making task that lies ahead:
...
- Assign a facilitator/timekeeper, notetaker and reporter
- Go around and--briefly--share your answers to the prompt
...
- After all groups have shared, offer suggestions to other groups and/or ask questions
