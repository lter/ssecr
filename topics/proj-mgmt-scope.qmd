...
![](topics/images/figure_mind-map.png){fig-alt="Bubble with a central concept or question, surrounded, at the first level, by inputs, outputs or modifiers and at the second level by question, concerns, or implications" .lightbox}
...
![](topics/images/figure_feasibility-matrix.png){fig-alt="x and y axes, labelled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" .lightbox}
