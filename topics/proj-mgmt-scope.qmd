...
![](topics/images/figure_feasibility-matrix.png){fig-alt="x and y axes, labeled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" .lightbox}
