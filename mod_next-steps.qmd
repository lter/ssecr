...
Break out into project groups. Assign a timekeeper, facilitator and reporter.  
...
-  Take 3-5 minutes of individual quiet time to come up with a related research idea or two that capitalize on the data you’ve assembled. (3-5 min)  
-  Share ideas in the group and nominate your top 3 (10 min)  
-  For each of those ideas (20 minutes)  
- Identify what additional data or analyses would be needed to clarify the nature and scale of the relationship  
-  Identify what the downstream effects of a change in our understanding of that relationship would be  
-  Brainstorm a list of people (individuals, groups, roles, agencies) who care about those changes or that intersect with them

For example, say your original project was focused on understanding what factors influence the long term immobilization of soil carbon during decomposition. Spinoff ideas might look at:

1.  additional controlling factors that you couldn’t include in the first effort; 
1.  a wider range of ecosystems; 
1.  the role of variability (not only temperature, for example, but also the frequency of freeze-thaw cycles);
1.  the effect of the same factors on the mobilization of nutrients in soil; or 
1.  scaling the analysis to forecast the impact on carbon sinks under alternative climate scenarios. 
...
No matter your audience, you need to put yourself in their shoes. Decision makers spend their limited resources to meet _their_ goals, no matter how exciting they find your science.

I’m going out on a limb here to say that ALL proposals need:
...
Anytime a project undergoes a major transition, it’s a good idea to revisit the approach to authorship. An agreement that worked well for an organized project with fixed membership may not be as appropriate for spinoff projects, spearheaded by individual team members and involving rotating groups of collaborators. 

Questions to consider in a next-phase authorship discussion include:
