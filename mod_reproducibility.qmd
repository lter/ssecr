...
:::{.callout-note}
### Activity: Consider Data FAIRness
...
Feel free to use these questions to jumpstart your thinking:

- How are the data for that project stored?
- What metadata exists to document those data?
- How easy would it be for someone else in your lab group to pick up and use your data?
