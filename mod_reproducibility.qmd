...
- Principles
    ...
    - 
- Simplest/best way of documenting a workflow is via a good file organization system
- Name and location of file should be very informative about the contents, purpose, and relation of that file to other project files
- One folder == one project
    - Increases ease of sharing, documenting, and collaborating
- No single "best" way to organize but _consistency_ will be a huge benefit regardless of the particular organization strategy
- Folder tips
    - Be consistent
...
- Machine readability
    - Avoid spaces, accented characters, and case sensitivity
    - Be consistent about delimiters
    - Consider "slugs" -- human-readable / unique pieces of file names that tie scripts together with their outputs
