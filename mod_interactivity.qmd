...
# Define the server ----
crab_server <- function(input, output){
...
# Generate the app ----
shiny::shinyApp(ui = crab_ui, server = crab_server)
```
...
4. We use `ggplot2` here but could use any plotting function/library
