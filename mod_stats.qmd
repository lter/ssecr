...
Content produced by project teams during the presentation component of this module may be included in the tab panels below or in the '[Additional Resources](https://lter.github.io/ssecr/mod_stats.html#additional-resources)' section at the bottom of this module _at the discretion of each team._
...
- Tredennick, A.T. _et al._ [A Practical Guide to Selecting Models for Exploration, Inference, and Prediction in Ecology](https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecy.3336). **2021**. _Ecology_
